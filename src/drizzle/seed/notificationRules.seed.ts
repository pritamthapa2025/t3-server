...
async function seedNotificationRulesInternal(): Promise<number> {
  ...
  const rules = [
    ...
    {
      category: "fleet",
      eventType: "safety_inspection_driver_reminder",
      description: "Safety Inspection Reminder (Assigned Driver)",
      enabled: true,
      priority: "high",
    ...
    {
      category: "fleet",
      eventType: "safety_inspection_assigned_escalation",
      description: "Safety Inspection Noncompliance (Assigned Driver Escalation)",
      enabled: true,
      priority: "high",
      recipientRoles: ["manager", "executive"],
      channels: ["email", "sms", "push"],
    ...
    {
      category: "fleet",
      eventType: "safety_inspection_timesheet_block_escalation",
      description:
        "Safety Inspection — Driver timesheet blocked after missed inspections",
      enabled: true,
      priority: "high",
      recipientRoles: ["manager", "executive"],
      channels: ["email", "sms", "push"],
    ...
    {
      category: "fleet",
      eventType: "safety_inspection_driver_timesheet_blocked",
      description: "Safety Inspection — Your timesheet is blocked until inspection",
      enabled: true,
      priority: "high",
      recipientRoles: ["driver"],
      channels: ["email", "sms", "push"],
