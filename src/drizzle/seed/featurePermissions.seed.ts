...
const FEATURES_DATA = [
  ...
  { module: "jobs", featureCode: "create_field_log", featureName: "Create Field Log", description: "Submit daily field log entries on jobs" },
  { module: "jobs", featureCode: "edit_field_log", featureName: "Edit Field Log", description: "Edit or delete field log entries" },
...
const ROLE_FEATURES_DATA = [
  ...
  { roleId: ROLES.TECHNICIAN, module: "jobs", featureCode: "create_field_log", accessLevel: "create" },
  { roleId: ROLES.TECHNICIAN, module: "jobs", featureCode: "edit_field_log", accessLevel: "edit_own" },
  ...
  { roleId: ROLES.MANAGER, module: "jobs", featureCode: "create_field_log", accessLevel: "create" },
  { roleId: ROLES.MANAGER, module: "jobs", featureCode: "edit_field_log", accessLevel: "edit_all" },
  ...
  { roleId: ROLES.EXECUTIVE, module: "jobs", featureCode: "create_field_log", accessLevel: "admin" },
  { roleId: ROLES.EXECUTIVE, module: "jobs", featureCode: "edit_field_log", accessLevel: "admin" },
